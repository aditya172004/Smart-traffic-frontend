	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'gradient-north': 'var(--gradient-north)',
				'gradient-south': 'var(--gradient-south)',
				'gradient-east': 'var(--gradient-east)',
				'gradient-west': 'var(--gradient-west)',
			...
			keyframes: {
				...
				'glow': {
					'0%, 100%': {
						boxShadow: '0 0 20px hsl(210 100% 50% / 0.3)'
					},
					'50%': {
						boxShadow: '0 0 40px hsl(210 100% 50% / 0.6)'
					}
				},
				'bounce-in': {
					'0%': {
